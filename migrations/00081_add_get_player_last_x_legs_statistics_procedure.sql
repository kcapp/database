-- +goose Up
ALTER TABLE match_default ADD leaderboard_active_period_weeks INT DEFAULT 2 NOT NULL;
ALTER TABLE match_default ADD leaderboard_last_legs_count INT DEFAULT 50 NOT NULL;
...
ALTER TABLE match_default DROP COLUMN leaderboard_active_period_weeks;
ALTER TABLE match_default DROP COLUMN leaderboard_last_legs_count;